...
func main() {
	...
	api := r.Group("/api")
	{
		...
		superSecured.Use(middleware.RequireSuperAdmin())
		{
			...
			superSecured.GET("/system/managed-plugins", handler.AdminManagedPluginList)
			superSecured.POST("/system/managed-plugins", handler.AdminManagedPluginSave)
			superSecured.DELETE("/system/managed-plugins/:id", handler.AdminManagedPluginDelete)
			superSecured.GET("/system/managed-templates", handler.AdminManagedTemplateList)
			superSecured.POST("/system/managed-templates", handler.AdminManagedTemplateSave)
			superSecured.DELETE("/system/managed-templates/:id", handler.AdminManagedTemplateDelete)
			superSecured.GET("/system/managed-ads", handler.AdminManagedAdList)
			superSecured.POST("/system/managed-ads", handler.AdminManagedAdSave)
			superSecured.DELETE("/system/managed-ads/:id", handler.AdminManagedAdDelete)
